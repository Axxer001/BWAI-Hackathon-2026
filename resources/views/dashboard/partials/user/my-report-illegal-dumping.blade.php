    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-5">
        ...
        <div class="lg:col-span-3 flex flex-col gap-5">
            <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden animate-slideUp"
                ...
                <form action="{{ route('reports.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="barangay_id" required
                            ...
                            /%3E%3C/svg%3E\");background-repeat:no-repeat;background-position:right 1rem center;background-size:1em;">
        ...
        <div class="lg:col-span-2 flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex gap-3 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 leading-relaxed">Your report is recorded with photo, coordinates, and timestamp.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 leading-relaxed">The barangay officer sees it on their dashboard and investigates.</p>
                            </div>
                        </div>
                        <div class="w-full h-px bg-white/[.06]"></div>
                        <div class="flex gap-3 items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 leading-relaxed">Report is either fined, dismissed, or resolved.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 flex flex-col overflow-hidden animate-slideUp" style="animation-delay: 0.2s;">
                ...
                <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                    ...
                    @if($reports->count() > 0)
                        <button type="button" id="openModalBtn" class="text-[11px] font-bold text-orange-500 hover:text-orange-600 transition-colors uppercase tracking-wide flex items-center gap-1">
                            View All &rarr;
                        </button>
                    @endif
                </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-10 text-center sm:p-0 pointer-events-none">
            ...
            <div class="relative bg-white rounded-2xl shadow-2xl flex flex-col w-full max-w-4xl max-h-[85vh] overflow-hidden pointer-events-auto transform transition-all">
                ...
                <div class="px-6 border-b border-slate-200 flex gap-8 overflow-x-auto no-scrollbar flex-shrink-0 bg-white">
                    <button class="tab-btn active text-sm font-bold py-4 border-b-2 border-orange-500 text-orange-600 transition-colors whitespace-nowrap" data-target-status="all">
                        All Reports
                    </button>
                    ...
                    <button class="tab-btn text-sm font-semibold py-4 border-b-2 border-transparent text-slate-500 hover:text-slate-800 transition-colors whitespace-nowrap" data-target-status="under review">
                        Under Review
                    </button>
                    <button class="tab-btn text-sm font-semibold py-4 border-b-2 border-transparent text-slate-500 hover:text-slate-800 transition-colors whitespace-nowrap" data-target-status="fined">
                        Fined / Resolved
                    </button>
                    <button class="tab-btn text-sm font-semibold py-4 border-b-2 border-transparent text-slate-500 hover:text-slate-800 transition-colors whitespace-nowrap" data-target-status="dismissed">
                        Dismissed
                    </button>
                </div>
                            ...
                            <div class="report-item bg-white p-5 rounded-xl border border-slate-200 flex flex-col md:flex-row gap-5 justify-between shadow-sm hover:shadow-md transition-shadow"
                                ...
                                <div class="flex-1">
                                    <div class="flex flex-wrap items-center gap-3 mb-2">
                                        ...
                                        <span class="text-xs text-slate-400 font-medium flex items-center gap-1 border-l border-slate-200 pl-3">
                                            <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    @if($aiDesc)
                                        <div class="mt-4 p-3 bg-slate-50 border border-slate-100 rounded-lg flex gap-3 items-start">
                                            <svg class="w-5 h-5 text-indigo-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
                                            </svg>
                                            <div>
                                                <p class="text-[10px] font-bold text-indigo-500 uppercase tracking-widest mb-0.5">AI Verification</p>
