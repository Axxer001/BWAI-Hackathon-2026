...
<body class="min-h-screen bg-slate-100 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-[920px] bg-white rounded-3xl shadow-[0_24px_60px_rgba(0,0,0,.12)] overflow-hidden flex min-h-[580px] animate-slideUp">
        ...
        <div class="flex-1 flex flex-col justify-center px-10 py-12">
            ...
            {{-- ═══════════ ERROR ALERT BANNER ═══════════ --}}
            @if($errors->any())
                <div class="mb-6 p-4 bg-red-50/80 border border-red-200 rounded-xl flex items-start gap-3 animate-slideUp" style="animation-duration: 0.3s;">
                    ...
                    <div class="pt-1.5">
                        <h3 class="text-sm font-bold text-red-800 leading-none mb-1">Authentication Failed</h3>
                        <p class="text-xs text-red-600 font-medium">
                            {{ $errors->first('email') ?: 'The provided credentials do not match our records.' }}
                        </p>
                    </div>
                </div>
            @endif
